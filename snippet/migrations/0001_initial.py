# Generated by Django 2.1.7 on 2019-05-26 19:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Author', models.ManyToManyField(to='snippet.Author')),
            ],
        ),
        migrations.CreateModel(
            name='Publishers',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('LEVEL', models.CharField(choices=[('12', 'ASE'), ('11', 'SE'), ('10', 'SSE')], default='Others', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spec', models.CharField(choices=[('TDS', 'Tech data stewards'), ('BAU', 'Business as usual'), ('ODS', 'Operational data store')], default='others', max_length=50)),
            ],
        ),
        migrations.AddField(
            model_name='resource',
            name='team',
            field=models.ManyToManyField(to='snippet.team'),
        ),
        migrations.AddField(
            model_name='book',
            name='publisher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pubs', to='snippet.Publishers'),
        ),
    ]
